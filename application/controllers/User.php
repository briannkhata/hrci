...
class User extends CI_Controller {
   ...
   function get_data_from_post(){
	...
	function view_profile($param=''){
    	$data['page_title']  = 'Staff Profile';
		$data['user_id']  = $param;
		$this->load->view($this->session->userdata('role').'/profile',$data);		
	} 

	function why_delete($param=''){
    	$data['page_title']  = 'Enter Reason for Deleting';
		$data['user_id']  = $param;
		$this->load->view($this->session->userdata('role').'/why_delete',$data);		
	} 
	...
	function delete($param=''){
		...
		$data['deletereason']  = $this->input->post('deletereason');
		$data['deleteaction']  = $this->input->post('deleteaction');
